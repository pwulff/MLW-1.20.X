package net.ratking.mlw.entity;

import net.ratking.mlw.MacLaveWorld;
import net.ratking.mlw.entity.custom.DiceProjectileEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, MacLaveWorld.MOD_ID);
