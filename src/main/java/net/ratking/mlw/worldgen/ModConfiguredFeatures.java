package net.ratking.mlw.worldgen;

import net.ratking.mlw.MacLaveWorld;
import net.ratking.mlw.block.ModBlocks;
import net.ratking.mlw.worldgen.tree.custom.PineFoliagePlacer;
import net.ratking.mlw.worldgen.tree.custom.PineTrunkPlacer;
...
public class ModConfiguredFeatures {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(MacLaveWorld.MOD_ID, name));
    }
