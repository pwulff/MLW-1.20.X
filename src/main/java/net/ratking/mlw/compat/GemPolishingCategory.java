...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(MacLaveWorld.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(MacLaveWorld.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.mlw.gem_polishing_station");
    }
