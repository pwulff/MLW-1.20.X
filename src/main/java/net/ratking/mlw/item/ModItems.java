...
import net.ratking.mlw.item.custom.*;
import net.ratking.mlw.sound.ModSounds;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, MacLaveWorld.MOD_ID);
    ...
    public static final RegistryObject<Item> SAPPHIRE_PICKAXE = ITEMS.register("sapphire_pickaxe",
            () -> new ModPickaxeItem(ModToolTiers.SAPPHIRE, 1, 1, new Item.Properties()));
